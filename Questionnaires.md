...
Distributed to mother in invitation package 3 weeks before Ultrasound appointment. See `instrument-documentation-q-father.pdf` for Instrument documentation and `SKJEMA_FAR_endringer.pdf (only in Norwegian)` for a description of changes between Version B/C and D/E. 
